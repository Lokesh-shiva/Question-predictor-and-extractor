  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        <div className="bg-indigo-100 p-4 rounded-full border border-indigo-200">
        ...
        <div>
          ...
          <p className="text-slate-600 text-sm mt-1">Drag & drop PDFs or Images here, or click to browse</p>
        </div>
